/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: 33da73a5bc36979ad3a86729ea2dd196)
...
interface __BaseEnv_Env {
	...
	DEFAULT_TAB: string;
	DEFAULT_ARCHIVE_COMPRESSION: string;
	DEFAULT_TRANSFER_METHOD: string;
	DEFAULT_LINK_TYPE: string;
	DEFAULT_EXPIRATION: string;
	MAX_EXPIRATION: string;
	DEFAULT_READS: number;
	DEFAULT_E2E_ENCRYPTION: boolean;
	BASIC_AUTH: object;
	R2_THRESHOLD: string;
	...
	TURN_URLS: string[];
	DEFAULT_QR_TX_FPS: number;
	DEFAULT_QR_FRAME_BYTES: number;
	DEFAULT_QR_ECC: string;
	DEFAULT_QR_LAYOUT: number;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOY_URL" | "REPO" | "INDEX_PAGE_TITLE" | "TOS_MAINTAINER" | "TOS_MAIL" | "CACHE_STATIC_PAGE_AGE" | "DEFAULT_TAB" | "DEFAULT_ARCHIVE_COMPRESSION" | "DEFAULT_TRANSFER_METHOD" | "DEFAULT_LINK_TYPE" | "DEFAULT_EXPIRATION" | "MAX_EXPIRATION" | "DEFAULT_READS" | "DEFAULT_E2E_ENCRYPTION" | "BASIC_AUTH" | "R2_THRESHOLD" | "R2_MAX_ALLOWED" | "DISALLOWED_MIME_FOR_PASTE" | "DEFAULT_P2P_EXPIRATION" | "MAX_P2P_EXPIRATION" | "DEFAULT_P2P_TRANSFERS" | "DEFAULT_P2P_VERIFY" | "TURN_URLS" | "DEFAULT_QR_TX_FPS" | "DEFAULT_QR_FRAME_BYTES" | "DEFAULT_QR_ECC" | "DEFAULT_QR_LAYOUT">> {}
}
declare module "*.html" {
	const value: string;
